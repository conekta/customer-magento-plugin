...
class TransactionAuthorize implements ClientInterface
{
    ...
    )
    {
        ...
        $this->_conektaLogger->info('HTTP Client Bnpl TransactionAuthorize :: __construct');
        $this->logger = $logger;
    ...
    {
        $this->_conektaLogger->info('HTTP Client Bnpl TransactionAuthorize :: placeRequest');
        ...
        $response['offline_info'] = [
            ...
            "data" => [
                ...
                "payment_url" => $paymentMethod->getPaymentUrl() ?? '',
                "monthly_installments" => $paymentMethod->getMonthlyInstallments() ?? '',
        ...
        $this->_conektaLogger->info(
            'HTTP Client Bnpl TransactionAuthorize :: placeRequest',
            [
                'request' => $request,
                'response' => $response
            ]
    ...
    {
        $this->_conektaLogger->info('HTTP Client Bnpl TransactionAuthorize :: generateResponseForCode');
