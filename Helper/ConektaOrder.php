...
//            return $this->conektaSession->getConektaCheckoutId();
        ...
        try {
            ...
            try {
                $this->conektaCustomer->find($conektaCustomerId);
            ...
            if (empty($conektaCustomerId)) {
                try {
                    ...
                    if ($customerId) {
                        ...
                        $request['phone'] = $shippingAddress->getTelephone();
                    } else {
                        $request['name'] = $shippingAddress->getName();
                        $request['email'] = $guestEmail;
                        $request['phone'] = $shippingAddress->getTelephone();
                    }
        ...
        $validOrderWithCheckout['force_3ds_flow'] = $iframeEnabled;
